<div class="footer">
		<div class="col-md-4 footer-left-agileits">
			<h3>Address</h3>
				<ul>
					<li><span class="glyphicon glyphicon-home" aria-hidden="true"></span>508/70,New Hydrabad,Lucknow,Uttar Pradesh</li>
					<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span><a href="abhaysingh0836481@outlook.com">abhaysingh0836481@outlook.com</a></li>
