        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                   ...
                   <li> <a href="#" class="waves-effect"><i class="fa fa-building fa-2x"></i> <span class="hide-menu"> || Hostels<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="new-house.php">Add a Hostel</a></li>
                            <li><a href="houses.php"> View Hostel</a></li>
                        </ul>
                    </li>
