                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                        		...
                        		<?php
									...
									if (isset($_GET["success"])) {
										...
										'<div class="alert alert-success" >
					                         ...
					                         <strong>DONE!! </strong><p> The new hostel has been added successfully.</p>
					                    </div>'
										;
									}
                                    elseif (isset($_GET["deleted"])) {
                                        ...
                                        '<div class="alert alert-warning" >
                                              <a href="#" class="close" data-dismiss="alert" aria-label="close"></a>
                                             <strong>DELETED!! </strong><p> The hostel has been successfully deleted.</p>
                                        </div>'
                                        ;
                                    }
                            ...
                            <h3 class="box-title m-b-0">Current hostel listings ( <x style="color: orange;"><?php echo mysqli_num_rows($query);?></x> )</h3>
